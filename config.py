...
MEDIUM_SKY_BLUE_SAT_MIN = 12     # Minimum saturation for blue sky in medium sky conditions
...
# Low Sky thresholds
LOW_SKY_BLUE_SAT_MIN = 5        # Minimum saturation for blue sky in low sky conditions
